...
#include "emmit/node_stream.h" // de donde salen los nodos que se recorren
...
const std::unordered_map<std::string, std::vector<InstrInfo>> InstrTable = {
    /* --- Informacion de VM --- */
    {"vminfo",
    ...
    {"inc",
     {{0x04, 0x00, InstrSizeMode::FIXED_2, AddressingMode::REG, emit_inc_dec}}},
    {"dec",
     {{0x04, 0x00, InstrSizeMode::FIXED_2, AddressingMode::REG, emit_inc_dec}}},
    ...
    /* --- Saltos relativos con desplazamiento de 32 bits (opcode extendido
       0x00 0x2D) --- */
    {"jrel",
     {{0x00, 0x2D, InstrSizeMode::FIXED_8, AddressingMode::INMED, emit_jrel}}},
    {"jrel.je",
     {{0x00, 0x2D, InstrSizeMode::FIXED_8, AddressingMode::INMED, emit_jrel}}},
    {"jrel.jz",
     {{0x00, 0x2D, InstrSizeMode::FIXED_8, AddressingMode::INMED, emit_jrel}}},
    ...
    {"pop",
     {{0x13, 0x00, InstrSizeMode::FIXED_2, AddressingMode::REG,
       emit_pop_push}}},
    {"xchg",
     {{0x14, 0x00, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_xchg}}},
    ...
    {"writecur",
     {{0x00, 0xC1, InstrSizeMode::FIXED_4, AddressingMode::REG,
       emit_cursor_rw}}},
    {"gcderef",
     {{0x00, 0xC2, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_gcderef}}},
    {"addcur",
     {{0x00, 0xC3, InstrSizeMode::FIXED_6, AddressingMode::INMED,
       emit_addcur}}},
    {"vmcopy",
     {{0x00, 0xC4, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_vmcopy}}},
    {"vcopyh",
     {{0x00, 0xC5, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_vcopyh}}},
    ...
    {"sext",
     {{0x00, 0x92, InstrSizeMode::FIXED_4, AddressingMode::INMED, emit_sext}}},
    ...
    {"and",
     {{0x00, 0x17, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_reg},
      {0x60, 0x00, InstrSizeMode::FIXED_4, AddressingMode::SIB,
       emit_instr_sib}}},
    {"or",
     {{0x00, 0x18, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_reg},
      {0x61, 0x00, InstrSizeMode::FIXED_4, AddressingMode::SIB,
       emit_instr_sib}}},
    {"xor",
     {{0x00, 0x19, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_reg},
    ...
    {"not",
     {{0x00, 0x1A, InstrSizeMode::FIXED_4, AddressingMode::REG,
       emit_instr_one_reg}}},
    {"shl",
     {{0x00, 0x1B, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_reg},
      {0x63, 0x00, InstrSizeMode::FIXED_4, AddressingMode::SIB,
       emit_instr_sib}}},
    {"shr",
     {{0x00, 0x1C, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_reg},
      {0x64, 0x00, InstrSizeMode::FIXED_4, AddressingMode::SIB,
       emit_instr_sib}}},
    {"sar",
     {{0x00, 0x1D, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_reg},
...
class Assembler {
  public:
    ...
    /// La fuente de nodos, con su contrato, vive en `emmit/node_stream.h`: en
    /// una cabecera aparte y minima para que quien PRODUZCA nodos no tenga que
    /// arrastrar el ensamblador entero.  Aqui solo se le da el nombre corto.
    using NodeStream = ::emmit::NodeStream;
