...
namespace Assembly::Bytecode {
    ...
    static const std::unordered_map<std::string, std::vector<InstrInfo> > InstrTable = {
        ...
        {"fadd.pd",  {{0x00, 0xF1, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fadd.ps",  {{0x00, 0xF1, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fsub",     {{0x00, 0xF2, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fsub.pd",  {{0x00, 0xF2, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fsub.ps",  {{0x00, 0xF2, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fmul",     {{0x00, 0xF3, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fmul.pd",  {{0x00, 0xF3, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fmul.ps",  {{0x00, 0xF3, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fdiv",     {{0x00, 0xF4, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fdiv.pd",  {{0x00, 0xF4, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fdiv.ps",  {{0x00, 0xF4, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fcmp",     {{0x00, 0xF5, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fcmp.pd",  {{0x00, 0xF5, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fcmp.ps",  {{0x00, 0xF5, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fsqrt",    {{0x00, 0xF6, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fsqrt.pd", {{0x00, 0xF6, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fsqrt.ps", {{0x00, 0xF6, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fabs",     {{0x00, 0xF7, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fabs.pd",  {{0x00, 0xF7, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fabs.ps",  {{0x00, 0xF7, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fneg",     {{0x00, 0xF8, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fneg.pd",  {{0x00, 0xF8, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        ...
        {"fmin",      {{0x00, 0x80, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fmin.ps",   {{0x00, 0x80, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fmax",      {{0x00, 0x81, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fmax.ps",   {{0x00, 0x81, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"ffloor",    {{0x00, 0x82, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"ffloor.ps", {{0x00, 0x82, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fceil",     {{0x00, 0x83, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fceil.ps",  {{0x00, 0x83, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fround",    {{0x00, 0x84, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"fround.ps", {{0x00, 0x84, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"ftrunc",    {{0x00, 0x85, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        {"ftrunc.ps", {{0x00, 0x85, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_freg}}},
        /* Sprint string-perf-5: bitcast GP<->ZMM directo (sin memoria). */
        {"bitg2z",    {{0x00, 0x86, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_bitcast_zg}}},
        {"bitz2g",    {{0x00, 0x87, InstrSizeMode::FIXED_4, AddressingMode::REG, emit_instr_bitcast_zg}}},
