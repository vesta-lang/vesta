...
namespace ir {
     ...
     */
    static constexpr uint16_t IR_SECTION_VERSION = 3;  // v3: + fn.section/section_perms (AOT 2b)
    ...
    static constexpr uint16_t IR_MODULE_CACHE_VERSION = 3;  // v3: + fn.section/perms + meta.section_perms (AOT 2b)
