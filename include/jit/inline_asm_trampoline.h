 ...
 * caller (el exec_fn del interp, o un test) escribe @c ctx[reg] para las
 * entradas, llama, y lee @c ctx[reg] para las salidas.
 */
 ...
 *        llamarse una vez al arranque (junto a @c
 * register_keystone_asm_backend).
 */
