 ...
 * @param alloc Asignacion materializada (FrameLayout + AllocationTimeline).  El
 * Rewrite consulta la ubicacion por MOMENTO del operando -- use/def -- via el
 *              timeline, sin conocer la convencion de posiciones ni la
 * representacion.
