...
namespace port {
    ...
    struct TranspileResult {
        ...
        std::vector<std::string> errors;   ///< Errores fatales si @c strict_unsupported.
    };
    ...
    struct EmitContext {
        ...
        const Transpiler     *tx;     ///< Puntero al transpiler para acceder a analisis (use_count, inline candidates).
    ...
    public:
         ...
         */
        virtual std::string format_value(EmitContext &ctx,
                                         ir::IrValueId v) const {
            (void)ctx;
         ...
         */
        virtual void emit_postamble(EmitContext &ctx, const ir::IrModule &mod) { (void)ctx; (void)mod; }
         ...
         */
        virtual void emit_fn_signature(EmitContext &ctx, const ir::IrFunction &fn) = 0;
         ...
         */
        virtual void emit_local_decl(EmitContext &ctx,
                                     ir::IrValueId id,
         ...
         */
        virtual void emit_cond_branch(EmitContext &ctx,
                                      ir::IrValueId cond,
        ...
        virtual void emit_const(EmitContext &ctx,
                                ir::IrValueId dst, uint64_t imm, ir::IrType t) = 0;

        /** Emite un copy: @c "v0 = v1;". */
        virtual void emit_mov(EmitContext &ctx,
                              ir::IrValueId dst, ir::IrValueId src, ir::IrType t) = 0;

        /** Emite una op binaria: @c "v0 = v1 + v2;". */
        virtual void emit_binop(EmitContext &ctx,
                                ir::IrOp op,
                                ir::IrValueId dst,
                                ir::IrValueId lhs,
                                ir::IrValueId rhs,
        ...
        virtual void emit_unop(EmitContext &ctx,
                               ir::IrOp op,
                               ir::IrValueId dst,
                               ir::IrValueId src,
                               ir::IrType t) = 0;
        ...
        virtual void emit_cmp(EmitContext &ctx,
                              ir::IrOp op,
                              ir::IrValueId dst,
                              ir::IrValueId lhs,
                              ir::IrValueId rhs,
        ...
        virtual void emit_convert(EmitContext &ctx,
                                  ir::IrOp op,
                                  ir::IrValueId dst,
                                  ir::IrValueId src,
                                  ir::IrType dst_type,
        ...
        virtual void emit_alloca(EmitContext &ctx,
                                 ir::IrValueId dst, uint64_t size_bytes) = 0;

        /** Emite LOAD: @c "v0 = *(int32_t*)v_addr;". */
        virtual void emit_load(EmitContext &ctx,
                               ir::IrValueId dst,
                               ir::IrValueId addr,
                               ir::IrType t,
                               bool is_host_ptr) = 0;
        ...
        virtual void emit_store(EmitContext &ctx,
                                ir::IrValueId val,
                                ir::IrValueId addr,
                                ir::IrType t,
                                bool is_host_ptr) = 0;
        ...
        virtual void emit_raw_alloc(EmitContext &ctx,
                                    ir::IrValueId dst, ir::IrValueId size) = 0;
        ...
        virtual void emit_call(EmitContext &ctx,
                               ir::IrValueId dst,
        ...
        virtual void emit_call_indirect(EmitContext &ctx,
                                        ir::IrValueId dst,
                                        ir::IrValueId fn_ptr,
                                        const std::vector<ir::IrValueId> &args,
                                        ir::IrType ret_type) = 0;
         ...
         */
        virtual void emit_callvirt(EmitContext &ctx,
                                   ir::IrValueId dst,
                                   ir::IrValueId obj,
                                   uint32_t vtable_idx,
                                   const std::vector<ir::IrValueId> &args,
                                   ir::IrType ret_type) {
            (void)ctx; (void)dst; (void)obj; (void)vtable_idx; (void)args; (void)ret_type;
            ctx.indent();
         ...
         */
        virtual void emit_unsupported(EmitContext &ctx,
         ...
         * @c "    v_dst = v_src;\n".
         */
        virtual void emit_phi_copy(EmitContext &ctx,
                                   ir::IrValueId dst,
                                   ir::IrValueId src,
                                   ir::IrType t);
    };
    ...
    class Transpiler {
    public:
        Transpiler(const ir::IrModule &mod,
                   const PortOptions &opts,
        ...
        /**
         * @brief Instruccion que define un SSA value (nullptr si param o no encontrada).
         */
    ...
    private:
        ...
        /**
         * @brief Emite un bloque basico completo: label + instrucciones + terminator.
         */
         ...
         */
        void emit_phi_copies_for_edge(EmitContext &ctx,
                                      const ir::IrFunction &fn,
         ...
         */
        void emit_block_terminator(EmitContext &ctx,
                                   const ir::IrFunction &fn,
                                   const ir::IrBlock &bb);
    };
