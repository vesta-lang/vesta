...
namespace vex {
    ...
    public:
        ...
        void on_borrow_drop(const std::string &borrower_name,
                            SourceLoc          loc_drop);
        ...
        bool on_owner_use(const std::string &owner_name,
                          SourceLoc          loc_use,
                          bool               is_mutation);
        ...
        bool on_owner_move(const std::string &owner_name,
                           SourceLoc          loc_move);
    ...
    private:
        ...
        void error_aliasing(SourceLoc          loc_conflict,
                            const std::string &owner_name,
