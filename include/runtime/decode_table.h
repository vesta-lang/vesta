...
/**
 * @file decode_table.h
 * @brief Declaracion de las tablas de despacho de instrucciones del bytecode VestaVM.
 *
 * Expone dos tablas de 256 entradas (InstrFormat[0x100]):
 *
 *   - decode_table_primary:  tabla de opcodes de un solo byte (0x01-0xFF).
 *     El byte 0x00 actua como prefijo de extension y redirige a la segunda tabla.
 *
 *   - decode_table_extended: tabla de opcodes extendidos; se accede cuando el
 *     primer byte de la instruccion es 0x00, usando el segundo byte como indice.
 *
