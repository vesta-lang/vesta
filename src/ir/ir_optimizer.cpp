 ...
 */
// ---------------------------------------------------------------------------
//  Reconocimiento de patrones: utilidades comunes
//
//  Un reconocedor de patrones no puede exigir que el codigo llegue escrito de
//  una forma exacta: el mismo dato aparece bajo valores SSA distintos segun
//  como se escribio el fuente y por que transformaciones haya pasado.  Estas
//  utilidades responden la pregunta que todos necesitan -- "estos dos valores
//  son el mismo dato" -- para que cada patron describa lo que busca y no la
//  forma concreta en que aparece.
// ---------------------------------------------------------------------------
 ...
 */
static const IrInstr *ir_def_of(const IrFunction &fn, IrValueId v) {
 ...
 */
static IrValueId ir_strip_copies(const IrFunction &fn, IrValueId v) {
 ...
 */
static bool ir_same_value(const IrFunction &fn, IrValueId x, IrValueId y) {
