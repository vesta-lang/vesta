...
namespace aot {
    ...
    AotOpClass aot_classify_op(IrOp op) noexcept {
        switch (op) {
            ...
            case IrOp::IABS: case IrOp::IMIN: case IrOp::IMAX:
            case IrOp::IMINU: case IrOp::IMAXU: case IrOp::ILOG2:
            // -- aritmetica flotante --
            ...
            case IrOp::FFLOOR: case IrOp::FCEIL: case IrOp::FROUND: case IrOp::FTRUNC:
            ...
            case IrOp::CLZ: case IrOp::CTZ: case IrOp::POPCNT:
            case IrOp::BYTESWAP: case IrOp::ROTL: case IrOp::ROTR:
            // -- comparaciones --
            case IrOp::CMP_EQ: case IrOp::CMP_NE:
            case IrOp::CMP_LT: case IrOp::CMP_GT: case IrOp::CMP_LE: case IrOp::CMP_GE:
            case IrOp::CMP_ULT: case IrOp::CMP_UGT: case IrOp::CMP_ULE: case IrOp::CMP_UGE:
            case IrOp::FCMP_EQ: case IrOp::FCMP_NE:
            case IrOp::FCMP_LT: case IrOp::FCMP_GT: case IrOp::FCMP_LE: case IrOp::FCMP_GE:
            // -- conversiones --
            ...
            case IrOp::UNREACHABLE: case IrOp::PHI:
            ...
            case IrOp::TAILCALL: case IrOp::CALLN:
            // -- memoria local / punteros crudos / copia inline --
            // MEMCPY baja a `rep movsb` inline: no necesita libc.
            case IrOp::ALLOCA: case IrOp::LOAD: case IrOp::STORE:
            case IrOp::GEP: case IrOp::MVTAKE_IR: case IrOp::ISNULL:
            case IrOp::MEMCPY:
            ...
            default:
                return AotOpClass::RUNTIME_DEPENDENT;
        }
    }
    ...
    static const char *aot_runtime_subsystem(IrOp op) noexcept {
        switch (op) {
            ...
            case IrOp::NEWOBJ: case IrOp::NEWOBJS:
            case IrOp::GETFIELD: case IrOp::SETFIELD:
            case IrOp::GC_ALLOC: case IrOp::GC_ALLOCP:
            case IrOp::GC_HANDLE_FOR_PTR: case IrOp::GC_DEREF_HOST:
            case IrOp::GCWB_IR: case IrOp::GCDEREF_IR:
                return "GC heap (libvesta_rt; en Bare/Embed: heap+stack estilo C++ via AOT.2)";
            case IrOp::GC_PROMOTE: case IrOp::GC_DEMOTE: case IrOp::SHARED_STAT:
                return "memoria compartida (Phase Z runtime)";
            case IrOp::GETSTATIC: case IrOp::SETSTATIC:
                return "campos estaticos de clase (ClassInfo runtime)";
            case IrOp::CALLVIRT: case IrOp::CALLM:
            case IrOp::CALLITF: case IrOp::CALLSUPER: case IrOp::PROCEED:
                return "dispatch virtual/interfaz (vtable/itable runtime)";
            case IrOp::CALLCLOSURE: case IrOp::READ_VM_REG:
                return "closures con entorno (heap/VM-ABI)";
            case IrOp::INSTANCEOF: case IrOp::CHECKCAST: case IrOp::SPECIALIZE:
                return "introspeccion de tipos runtime";
            case IrOp::ARRAY_ALLOC: case IrOp::ARRAY_LEN:
            case IrOp::ARRAY_LOAD: case IrOp::ARRAY_STORE:
                return "arrays managed (helper runtime)";
            case IrOp::STRMAKE: case IrOp::STRLEN: case IrOp::STRCAT:
            case IrOp::STRCMP: case IrOp::STRSLICE: case IrOp::STRFLAT:
            case IrOp::STRHASH: case IrOp::STRINTERN: case IrOp::STRRAW:
            case IrOp::STRCONV: case IrOp::STRRESERVE: case IrOp::STRFINALIZE:
            case IrOp::STRGETBYTES:
                return "strings GC (StringObject)";
            case IrOp::THROW: case IrOp::TRYENTER: case IrOp::TRYLEAVE:
            case IrOp::LANDINGPAD: case IrOp::RETHROW: case IrOp::UNWRAP:
                return "excepciones (unwinding runtime; ver AOT.7)";
            case IrOp::FUTURE: case IrOp::AWAIT: case IrOp::FULFILL:
            case IrOp::REJECT: case IrOp::FULFILL_HLT:
                return "async/futures (scheduler)";
            case IrOp::MSGSEND: case IrOp::MSGRECV:
            case IrOp::RSPAWN: case IrOp::RSPAWN_RETURN:
                return "distribucion (mailbox/VDP)";
            case IrOp::MONENTER: case IrOp::MONEXIT: case IrOp::MONWAIT:
            case IrOp::MONNOTI: case IrOp::MONNOTA:
                return "monitores/synchronized (runtime)";
            case IrOp::GETPROC: case IrOp::GETVM: case IrOp::GETMGR:
                return "contexto VM (ProcessVM/VM)";
            case IrOp::SPAWN: case IrOp::RESUME: case IrOp::YIELD:
            case IrOp::SWAPCTX: case IrOp::SPAWN_ARGS: case IrOp::SPAWN_ON:
            case IrOp::HLT: case IrOp::GETPID:
            case IrOp::GETARGC: case IrOp::GETARG:
                return "scheduler/procesos (runtime)";
            case IrOp::FINDCLASS: case IrOp::DEFCLASS: case IrOp::DEFFIELD:
            case IrOp::DEFMETHOD: case IrOp::ADDADVICE:
            case IrOp::FINDMETHOD: case IrOp::FINDFIELD: case IrOp::SETMETHDBG:
                return "classregistry/AOP (runtime)";
            case IrOp::REFLECT_COUNT: case IrOp::REFLECT_AT:
                return "reflexion (runtime)";
            case IrOp::MOD_LOAD: case IrOp::DLOPEN: case IrOp::DLSYM:
                return "carga dinamica de modulos (runtime/FFI dlopen)";
            case IrOp::RAW_ASM:
    ...
    static bool aot_op_embed_supported(IrOp op) noexcept {
        switch (op) {
            ...
            case IrOp::CALLCLOSURE: case IrOp::READ_VM_REG:
            // tipos
            case IrOp::INSTANCEOF: case IrOp::CHECKCAST:
            // arrays managed
            case IrOp::ARRAY_ALLOC: case IrOp::ARRAY_LEN:
            case IrOp::ARRAY_LOAD: case IrOp::ARRAY_STORE:
            // strings
    ...
    const char *aot_op_requirement(IrOp op, const AotTarget &target) noexcept {
        ...
        if (cls == AotOpClass::LIBC_MAPPED) {
            ...
            switch (op) {
                ...
                default:
                    return "libc (no disponible en --freestanding)";
            }
        }
    ...
    bool aot_analyze_function(const ir::IrFunction &fn, const AotTarget &target,
        ...
        for (const ir::IrBlock &blk : fn.blocks) {
            for (const ir::IrInstr &ins : blk.instrs) {
                if (aot_op_allowed(ins.op, target))
                    continue;
                ok = false;
                AotIncompat issue;
    ...
    std::string AotCompatReport::render() const {
        ...
        const char *tier_name =
            (target.tier == Tier::BARE) ? "bare" :
            (target.tier == Tier::EMBED) ? "embed" : "full";
        ...
        for (const AotIncompat &it : issues) {
            os << "  fn '" << it.fn_name << "'";
            if (it.source_line != 0)
                os << " linea " << it.source_line;
            os << ": op '" << ir::ir_op_name(it.op) << "' requiere "
               << it.reason << "\n";
        }
