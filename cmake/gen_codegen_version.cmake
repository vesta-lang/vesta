...
# Vex y la escribe como VXI_COMPILER_BUILD_ID en un header generado.
#
# Proposito: invalidar los caches .vxi / .vxir / .vpc SOLO cuando cambia el
...
# mismo hash -> el header no se reescribe -> vxi_format.cpp no se recompila ->
...
string(APPEND _content "// Hash de las fuentes de codegen; invalida los caches .vxi/.vxir/.vpc\n")
string(APPEND _content "// cuando el codigo de generacion del compilador cambia.\n")
string(APPEND _content "#define VXI_COMPILER_BUILD_ID \"vxcg-${_final}\"\n")
...
if(NOT _old STREQUAL _content)
    ...
    message(STATUS "[vx-codegen-version] actualizado: vxcg-${_final}")
endif()
