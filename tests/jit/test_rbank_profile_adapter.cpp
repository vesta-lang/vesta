 ...
 *        y que el OptimizationContext PREFIERE el peso medido sobre el estatico.
 */
...
int main() {
    ...
    ir::IrFunction fn; fn.name = "loop1";
    ...
    analysis::ProfileFacts pf = analysis::compute_profile_facts(fn, loops, prof);

    std::printf("\n[ProfileAdapter -> execution_weight]\n");
    {
        // Valor definido en el body (bloque 2), peso = trip = 7.
        ValueRequirements r; r.loop_depth = 1;
    ...
    std::printf("\n[el contexto PREFIERE el peso medido]\n");
    {
        ...
        ValueRequirements measured; measured.loop_depth = 1;
        ...
        ValueRequirements no_prof; no_prof.loop_depth = 2; // sin execution_weight
    ...
    {
        ValueRequirements r;
        r.value_id = 3; r.crosses_call = true; r.loop_depth = 1;
