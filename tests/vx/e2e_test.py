...
fails_case("find_type_rt_err", "find_type con una cadena de ejecucion", "562_find_type_runtime_err.vx", "VX2085", line=2149)
...
fails_case("cb_float_err", "callback nativo con flotante en la firma", "561_callback_float_err.vx", "VX2082", line=2385)
...
modes3_case("const_flotante_global",
...
# `out` no es receptor, y se dice por que: el nombre existe y la funcion tambien, asi
# que negarla a secas manda a buscar una que esta escrita ahi mismo.  La linea no es
# "por referencia si o no" -- `inout` va igual y SI vale --, es de donde sale el valor.
