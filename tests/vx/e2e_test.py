...
r0_case("dtorslot484", "el destructor de un unique<T> se llama tambien si cae en el hueco cero de la tabla o si lo sobrescribe una derivada", "484_dtor_slot_cero.vx", 42, line=3766)
