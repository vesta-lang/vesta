...
fn print_help() {
    ...
    help_row("b <file>:<line> [pid]",    "set bp por linea Vesta-lang (--vx-debug)")
    ...
    help_row("until <line> [pid]",       "correr hasta linea Vesta-lang (file inferido)")
    help_row("until <file>:<line> [pid]","correr hasta linea Vesta-lang especifica")
